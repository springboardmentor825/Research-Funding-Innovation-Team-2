/* =========================================================
   ...
   Modified App.js
   Pure browser-executable JS
   React 18 UMD + Recharts UMD
   ========================================================= */
...
const COMMERCIALIZATION_OPPORTUNITIES = [
  {
    id: "COM-001",
    technology: "Federated Machine Learning",
...
const licenseData = [
  {
    name: "Open-source",
    value: RAW.filter((d) =>
      d.license.includes("Open-source")
    ).length
  },
  {
    name: "Proprietary",
    value: RAW.filter((d) =>
      d.license.includes("Proprietary")
    ).length
  }
];
...
RAW.forEach((d) => {
  const dec =
    Math.floor(d.year / 10) * 10;

  const k = dec + "s";

  if (decadeMap[k] !== undefined) {
    decadeMap[k]++;
  }
});
...
const topTech = [...RAW]
  .sort(
    (a, b) =>
      commScore(b.community) -
      commScore(a.community)
  )
  .slice(0, 8);
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        item.org ||
          `${item.sector} · ${item.readiness} readiness`
      ),
      ...
      h(
        ...
        h(
          ...
          item.desc ||
            `Technology: ${item.technology}. Sector: ${item.sector}. Estimated market opportunity: ${item.market}. Commercialization score: ${item.score}/100.`
        )
      ),
...
function OverviewView({
  ...
  const realResearchProfiles =
    collections.research_profiles ||
    0;

  const realResearchDomains =
    collections.research_domains ||
    0;
...
function CommercializationView({
  setSelectedItem
}) {
  return h(
    "div",
      ...
      h(
        ...
        h(
          ...
          h(
            ...
            COMMERCIALIZATION_OPPORTUNITIES.map(
              (item) =>
                h(
                  "tr",
                  {
      ...
      h(
        ...
        h(
          ...
          h(
            ...
            "Strong market demand, high technical readiness and significant privacy requirements make healthcare a high-value commercialization target."
          )
        )
      ),
      ...
      h(
        ...
        h(
          ...
          h(
            ...
            "Move high-readiness technologies from prototype to pilot stage by identifying industry partners and validating commercial use cases."
          ),
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        "Top Impact Publications (Click for Details)"
      ),
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        "Intellectual Property Registry (Click for Details)"
      ),
...
if (!rootElement) {
  console.error(
    "ERROR: Cannot find <div id='root'></div> in index.html"
  );
} else if (
  typeof ReactDOM ===
  "undefined"
  ...
  console.error(
    "ERROR: ReactDOM is not loaded. Check your React CDN in index.html."
  );
} else if (
  typeof Recharts ===
  "undefined"
  ...
  console.error(
    "ERROR: Recharts is not loaded. Check your Recharts CDN in index.html."
  );
} else {
  const root =
    ReactDOM.createRoot(
